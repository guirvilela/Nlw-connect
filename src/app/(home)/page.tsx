...
import { SubscriptionForm } from "../components/home-page/subscription-form";
        ...
        <section className="flex-1 bg-gray-700 border border-gray-600 rounded-2xl p-8 space-y-6 ">
          <div className="flex items-center justify-between">
            ...
            <span className="text-purple font-semibold text-xs flex items-center gap-2">
              <Radio className="size-5 r " />
              AO VIVO
            </span>
          </div>
          <p className="text-gray-300 leading-relaxed text-sm md:text-base">
            Um evento feito por e para pessoas desenvolvedoras apaixonadas por
            criar soluções inovadores e compartilhar conhecimneot. Vamos
            mergular nas tendências mais recentes em desenvolvimento de
            software, arquitetura de sistemas e tecnologias emergentes, com
            paletras, workshops e hackthons;
            <br />
            <br />
