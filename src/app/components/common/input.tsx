...
interface InputMessageProps extends ComponentProps<"input"> {}

export function InputMessageError({ ...props }: InputMessageProps) {
  return <p className="text-gray-400 text-sm -mt-2" {...props}></p>;
}
